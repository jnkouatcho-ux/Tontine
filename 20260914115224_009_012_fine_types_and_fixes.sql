-- 009: Fine types and applications
...
-- 011: Add payment_method and source_category_id to fine_applications
...
-- 012: Add destination_category_id to fine_applications
ALTER TABLE fine_applications
  ADD COLUMN IF NOT EXISTS destination_category_id uuid REFERENCES categories(id) ON DELETE SET NULL;